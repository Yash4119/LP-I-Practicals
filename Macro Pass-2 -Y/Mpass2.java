...
public class Mpass2 {
	...
	public static void main(String[] args) throws IOException {
		...
		BufferedReader br1 = new BufferedReader(new FileReader("G:\\LP-I\\Macro Pass 2\\mnt.txt"));
		String line;
		...
		br1 = new BufferedReader(new FileReader("G:\\LP-I\\Macro Pass 2\\arglist.txt"));
		while ((line = br1.readLine()) != null) {
		...
		br1 = new BufferedReader(new FileReader("G:\\LP-I\\Macro Pass 2\\mdt.txt"));
		while ((line = br1.readLine()) != null) {
			MDT[mdt_cnt] = new mdt();
		...
		br1 = new BufferedReader(new FileReader("G:\\LP-I\\Macro Pass 2\\input.txt"));
		arglist[] actual_parameter = new arglist[10];

		BufferedWriter bw1 = new BufferedWriter(new FileWriter("G:\\LP-I\\Macro Pass 2\\output.txt"));
		while ((line = br1.readLine()) != null) {
			...
			for (String current_token : tokens) {
				...
				if (macro_end && !macro_start) {
					if (macro_call != -1 && temp_cnt < formal_arglist_cnt - 1) {
						...
						// para="+actual_parameter[actual_arglist_cnt-1].argname);
